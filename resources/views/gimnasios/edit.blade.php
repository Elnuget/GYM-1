        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('gimnasios.update', $gimnasio) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <select id="dueno_id" name="dueno_id" required class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm rounded-md @error('dueno_id') border-red-500 @enderror">
                                ...
                                @foreach(\App\Models\DuenoGimnasio::all() as $dueno)
                                    <option value="{{ $dueno->id_dueno }}" {{ (old('dueno_id', $gimnasio->dueno_id) == $dueno->id_dueno) ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $gimnasio->nombre) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="direccion" id="direccion" value="{{ old('direccion', $gimnasio->direccion) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="telefono" id="telefono" value="{{ old('telefono', $gimnasio->telefono) }}"
