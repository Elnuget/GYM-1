            ...
            if(user) {
                this.$nextTick(() => {
                    ...
                    user.roles.forEach(role => {
                        document.getElementById('edit_role_' + role.id).checked = true;
                    });
                });
            }
        }
                        ...
                        <table class="min-w-full divide-y divide-emerald-200">
                            <thead class="bg-gradient-to-r from-emerald-600 to-teal-600">
                                <tr>
                                    ...
                                    <th class="px-6 py-4 text-left text-xs font-medium text-white uppercase tracking-wider">Roles</th>
                                    ...
                                    <tr class="hover:bg-gradient-to-r hover:from-emerald-50 hover:to-teal-50 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-3">
                                                <button @click="toggleEditModal({{ $user->load('roles') }})" 
                            ...
                            <div class="p-6">
                                ...
                                <form action="{{ route('users.store') }}" method="POST">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-emerald-700 mb-2">Roles</label>
                    ...
                    <div class="flex items-center justify-center min-h-screen p-4">
                        <div class="relative bg-gradient-to-br from-white to-emerald-50 rounded-xl max-w-md w-full shadow-xl">
                            <div class="p-6">
                                ...
                                <form x-bind:action="'/users/' + currentUser?.id" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="space-y-4">
                                        <div>
