...
<!-- Desktop Sidebar Navigation (oculto en móvil) -->
        ...
        <div class="flex-1 space-y-1 px-2">
            ...
            <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" 
                ...
                <div class="flex items-center" :class="{'justify-center w-full': !isExpanded}">
                    ...
                    <span x-cloak x-show="isExpanded" 
                          class="ml-3 whitespace-nowrap">{{ __('Panel') }}</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('membresias.index')" :active="request()->routeIs('membresias.*')" 
                ...
                <div class="flex items-center" :class="{'justify-center w-full': !isExpanded}">
                    ...
                    <span x-cloak x-show="isExpanded" 
                          class="ml-3 whitespace-nowrap">{{ __('Membresías') }}</span>
                </div>
            </x-nav-link>

            <!-- Training Section Header -->
            <div x-cloak x-show="isExpanded" class="mt-6 mb-2">
                <span class="px-3 text-xs font-semibold text-emerald-300 uppercase tracking-wider">Entrenamiento</span>
            </div>
            ...
            <x-nav-link :href="route('rutinas-predefinidas.index')" :active="request()->routeIs('rutinas-predefinidas.*')" 
                ...
                <div class="flex items-center" :class="{'justify-center w-full': !isExpanded}">
                    ...
                    <span x-cloak x-show="isExpanded" 
                          class="ml-3 whitespace-nowrap">{{ __('Rutinas Predefinidas') }}</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('asignacion-rutinas.index')" :active="request()->routeIs('asignacion-rutinas.*')" 
                ...
                <div class="flex items-center" :class="{'justify-center w-full': !isExpanded}">
                    ...
                    <span x-cloak x-show="isExpanded" 
                          class="ml-3 whitespace-nowrap">{{ __('Asignación de Rutinas') }}</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('roles.index')" :active="request()->routeIs('roles.*')" 
                ...
                <div class="flex items-center" :class="{'justify-center w-full': !isExpanded}">
                    ...
                    <span x-cloak x-show="isExpanded" 
                          class="ml-3 whitespace-nowrap">{{ __('Roles y Permisos') }}</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('users.index')" :active="request()->routeIs('users.*')" 
                ...
                <div class="flex items-center" :class="{'justify-center w-full': !isExpanded}">
                    ...
                    <span x-cloak x-show="isExpanded" 
                          class="ml-3 whitespace-nowrap">{{ __('Usuarios') }}</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('duenos-gimnasio.index')" :active="request()->routeIs('duenos-gimnasio.*')" 
                ...
                <div class="flex items-center" :class="{'justify-center w-full': !isExpanded}">
                    ...
                    <span x-cloak x-show="isExpanded" 
                          class="ml-3 whitespace-nowrap">{{ __('Dueños de Gimnasios') }}</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('gimnasios.index')" :active="request()->routeIs('gimnasios.*')" 
                ...
                <div class="flex items-center" :class="{'justify-center w-full': !isExpanded}">
                    ...
                    <span x-cloak x-show="isExpanded" 
                          class="ml-3 whitespace-nowrap">{{ __('Gimnasios') }}</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('pagos-gimnasios.index')" :active="request()->routeIs('pagos-gimnasios.*')" 
                ...
                <div class="flex items-center" :class="{'justify-center w-full': !isExpanded}">
                    ...
                    <span x-cloak x-show="isExpanded" 
                          class="ml-3 whitespace-nowrap">{{ __('Pagos de Gimnasios') }}</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('clientes.index')" :active="request()->routeIs('clientes.*')" 
                ...
                <div class="flex items-center" :class="{'justify-center w-full': !isExpanded}">
                    ...
                    <span x-cloak x-show="isExpanded" 
                          class="ml-3 whitespace-nowrap">{{ __('Clientes') }}</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('asistencias.index')" :active="request()->routeIs('asistencias.*')" 
                ...
                <div class="flex items-center" :class="{'justify-center w-full': !isExpanded}">
                    ...
                    <span x-cloak x-show="isExpanded" 
                          class="ml-3 whitespace-nowrap">{{ __('Control de Asistencias') }}</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('nutricion.index')" :active="request()->routeIs('nutricion.*')" 
                ...
                <div class="flex items-center" :class="{'justify-center w-full': !isExpanded}">
                    ...
                    <span x-cloak x-show="isExpanded" 
                          class="ml-3 whitespace-nowrap">{{ __('Nutrición') }}</span>
                </div>
            </x-nav-link>
    ...
    <div class="sticky bottom-0 w-full border-t border-teal-600/50 bg-gradient-to-br from-cyan-600 via-teal-700 to-emerald-800">
        <div class="p-2">
            ...
            <form method="POST" action="{{ route('logout') }}" class="mt-2">
                @csrf
                <button type="submit" 
                        class="w-full flex items-center p-2 text-gray-100 hover:bg-orange-500/20 hover:text-orange-200 rounded-lg transition-all duration-200"
                        :class="{'justify-center': !isExpanded}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                            d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/>
                    ...
                    <span x-cloak x-show="isExpanded"
                          class="ml-3 whitespace-nowrap">{{ __('Cerrar Sesión') }}</span>
                </button>
            </form>
        </div>
    </div>
